...
namespace AvoidObstacleBoidsNNTest
{
    public partial class FormAvoidObstacleBoidsNNTest : Form
    {
        private readonly AvoidObstacleNNTestController _controller;
        private readonly DispatcherTimer _timer = new DispatcherTimer();
        public FormAvoidObstacleBoidsNNTest()
        {
            InitializeComponent();

            _controller = new AvoidObstacleNNTestController();
        ...
        {
            _controller.CreateRenderer(new AvoidObstacleNNTestRenderer(e.Surface.Canvas));
